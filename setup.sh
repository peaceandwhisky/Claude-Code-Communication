...
echo "     # 手順1: President認証（自動許可モード）"
echo "     tmux send-keys -t president 'claude --approve' C-m"
echo "     # 手順2: 認証後、multiagent一括起動（自動許可モード）"
echo "     for i in {0..3}; do tmux send-keys -t multiagent:0.\$i 'claude --approve' C-m; done"
echo ""
echo "  3. 📜 指示書確認:"
